...
HD_PWD='D:/iraide/sistemasdigitales/act5_gcd/act5_gcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd3.tcl
